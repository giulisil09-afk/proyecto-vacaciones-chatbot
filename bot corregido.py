##===============================
# Proyecto de Gestión de Vacaciones 
## Alumna: Lourdes Silva
## Descripción: 
#Aplicación desarrollada en Python para gestionar
#solicitudes de vacaciones utilizando una base de # datos en Excel. 
# Funcionalidades: 
# - Consulta de empleados.
# - Validación de legajo. 
# - Cálculo automático de días solicitados.
# - Actualización de días disponibles.
# - Registro de solicitudes con estado (aprobada/rechazada).
##===============================
import pandas as pd
